...
public class App {
    ...
    private static void menuCardapio(){
        while (true){
            System.out.println(
                "\n-- Cardápio --\n" +
                "1) Cadastrar item do cardápio\n" +
                "2) Listar itens do cardápio\n" +
                "0) Voltar"
            );
            System.out.print("Opção: ");
            String op = in.nextLine().trim();
    ...
    private static void menuRelatorios(){
        while (true){
            System.out.println(
                "\n-- Relatórios --\n" +
                "1) Relatório do dia (simplificado)\n" +
                "2) Relatório do dia (detalhado)\n" +
                "0) Voltar"
            );
            System.out.print("Opção: ");
            String op = in.nextLine().trim();
            switch (op){
                case "1" -> relatorioSimplificado();
